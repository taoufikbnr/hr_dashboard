...
const handleSearch = (e) => {
  ...
  if(searchInput===''){
    ...
    const filtredNationalities = nationalitiesData.nationalities.filter((nationality) =>nationality.toLowerCase()
  ...
  return (
    <div className="nationalities-container">
      ...
      <div  className='selected-nationalities'>
        {el}<Close className='closeBtn' onClick={() => handleDeselectNationality(el)}/>
      </div> )}
